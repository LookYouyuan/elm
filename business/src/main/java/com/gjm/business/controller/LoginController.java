...
public class LoginController {
    ...
    public String doLogin(Business business, HttpSession session, ModelMap modelMap){
        String forward = "";
        Business login = this.businessService.login(business);
        if(login != null){
            session.setAttribute("business",login);
            forward = "index";
        }else {
