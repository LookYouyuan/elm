<template>
	<div class="wrapper">
		...
		<header>
			...
			<div class="location-text">淄博市山东理工大学<i class="fa fa-caret-down"></i></div>
		</header>
		...
		<div class="search">
			...
			<div class="search-fixed-top" ref="fixedBox">
				...
				<div class="search-box">
				   <input style="width:100%;height:100%; border:none; outline:none;text-align:center;" type="text"  placeholder="请输入..."  @change="setfoodname($event)" />
				</div>
			</div>
		</div>
	...
	export default {
		...
		methods:{
		    setfoodname(foodname){
            	...
            	var foodname = foodname.target.value;
            	this.$setLocalStorage("foodname",foodname);
            	this.$router.push({path:'/foodResult',query:{foodname:foodname}});
